...
.then(() => mailGun.sendEmail({
  ...
  attachment: [
    {
      fType: 'image/png',
      fLoc: path.resolve(__dirname, '..', 'test', 'screenshots', 'travis', 'debug1.png')
    },
    {
      fType: 'image/png',
      fLoc: path.resolve(__dirname, '..', 'test', 'screenshots', 'travis', 'debug2.png')
    },
    {
      fType: 'image/png',
      fLoc: path.resolve(__dirname, '..', 'test', 'screenshots', 'travis', 'debug3.png')
    }
  ]
}))
